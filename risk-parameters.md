...
**Reserve Factor.** The percentage of interest earnings that go to the protocol treasury instead of suppliers. K2 uses two tiers: stablecoins are set at 10% and all other assets are between 15-20%.
